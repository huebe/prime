...
#define SET_BIT_ULONGLONG_ARRAY(arr, i) ( arr[i/ULONGLONG_SIZE_BITS] |= 1 << (i % ULONGLONG_SIZE_BITS) )
#define CLEAR_BIT_ULONGLONG_ARRAY(arr, i) ( arr[i/ULONGLONG_SIZE_BITS] &= ~(char)(1 << (i % ULONGLONG_SIZE_BITS)) )
